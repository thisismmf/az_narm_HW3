...
public class AccountBalanceCalculatorTest {
    ...
    void testTransactionHistoryAfterDepositsAndWithdrawals() {
        ...
        // Check if the transactions are correctly recorded
        assertTrue(history.containsAll(transactions),
                "Transaction history should contain all deposit and withdrawal transactions");
    }
    ...
    void testTransactionHistoryShouldContainOnlyLastCalculationTransactions() {
        ...
        assertEquals(2, historyAfterFirstCalc.size(),
                "Transaction history should contain 2 transactions after the first calculation");
        assertTrue(historyAfterFirstCalc.containsAll(firstTransactions),
                "Transaction history should contain the first set of transactions");
        ...
        assertEquals(2, historyAfterSecondCalc.size(),
                "Transaction history should contain 2 transactions after the second calculation");
